...
@interface SharedFavoritesViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^favoritesFlow)(SharedKotlinUnit *(^)(NSArray<SharedPokemon *> *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("favoritesFlow")));
@property (readonly) NSArray<SharedPokemon *> *favorites __attribute__((swift_name("favorites")));
@end

@interface SharedPokemonDetailViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^stateFlow)(SharedKotlinUnit *(^)(SharedPokemonDetailState *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("stateFlow")));
@property (readonly) SharedPokemonDetailState *state __attribute__((swift_name("state")));
@end

@interface SharedPokemonListViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^stateFlow)(SharedKotlinUnit *(^)(SharedPokemonListState *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("stateFlow")));
@property (readonly) SharedPokemonListState *state __attribute__((swift_name("state")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRepositoryNativeKt")))
@interface SharedPokemonRepositoryNativeKt : SharedBase
+ (SharedKotlinUnit *(^(^)(SharedKotlinUnit *(^)(id _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void))getPokemonDetail:(id<SharedPokemonRepository>)receiver name:(NSString *)name __attribute__((swift_name("getPokemonDetail(_:name:)")));
+ (SharedKotlinUnit *(^(^)(SharedKotlinUnit *(^)(id _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void))getPokemonPage:(id<SharedPokemonRepository>)receiver limit:(int32_t)limit offset:(int32_t)offset __attribute__((swift_name("getPokemonPage(_:limit:offset:)")));
+ (SharedKotlinUnit *(^(^)(SharedKotlinUnit *(^)(NSArray<SharedPokemon *> *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void))observeFavorites:(id<SharedPokemonRepository>)receiver __attribute__((swift_name("observeFavorites(_:)")));
+ (SharedKotlinUnit *(^(^)(SharedKotlinUnit *(^)(SharedKotlinUnit *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void))setFavorite:(id<SharedPokemonRepository>)receiver id:(int32_t)id name:(NSString *)name imageUrl:(NSString *)imageUrl isFavorite:(BOOL)isFavorite __attribute__((swift_name("setFavorite(_:id:name:imageUrl:isFavorite:)")));
@end
