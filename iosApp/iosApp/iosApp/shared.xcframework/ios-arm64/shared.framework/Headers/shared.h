...
*/
- (void)getPokemonDetailName:(NSString *)name completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getPokemonDetail(name:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPokemonPageLimit:(int32_t)limit offset:(int32_t)offset completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getPokemonPage(limit:offset:completionHandler:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)observeFavorites __attribute__((swift_name("observeFavorites()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setFavoriteId:(int32_t)id name:(NSString *)name imageUrl:(NSString *)imageUrl isFavorite:(BOOL)isFavorite completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("setFavorite(id:name:imageUrl:isFavorite:completionHandler:)")));
@end
