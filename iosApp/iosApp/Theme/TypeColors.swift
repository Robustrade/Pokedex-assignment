...
/// Maps Pokémon type strings to their canonical colours.
enum TypeColors {
    ...
    /// Lighter tint suitable for backgrounds.
    static func background(for type: String) -> Color {
        color(for: type).opacity(0.25)
    }
}
